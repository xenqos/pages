...
|il fait chaud||тепло
|il fait nuageux||облачно
|il fait beau||приятная погода
|il fait doux||мягкая погода
|il fait orageux||грозовая погода
...
|il gèle||морозно
|il grêle||идёт град
|il fait ____ degrés.||____ градусов
|il pleut des cordes||льёт как из ведра
|il caille||морозно (разг.)
|ça caille||морозно (разг.)
