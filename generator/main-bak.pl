...
, '0|toolbox/mystic-rhymes|Мистические рифмы'

, '0|exoterica/zh-daodejing|Дао Дэ Цзин'
, '0|exoterica/zh-stratagems|Стратагемы'
, '0|exoterica/zh-taiji-fuzhongwen|Тай Чи - Fu Zhong Wen'
, '0|exoterica/zh-taiji-moylinshin|Тай Чи - Moy Lin Shin'

, '0|money/banknotes-eur|Banknotes EUR'
);

#-----------------------------------------------------------

our $dir_prefix       = '/home/lux/mnt/data/Webpages/zones';
